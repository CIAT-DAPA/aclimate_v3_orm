...
class ClimateMeasure(Base):
    ...
    climate_historical_daily = relationship("ClimateHistoricalDaily", back_populates="measure")
    climate_historical_monthly = relationship("ClimateHistoricalMonthly", back_populates="measure")
    climate_historical_climatology = relationship("ClimateHistoricalClimatology", back_populates="measure")
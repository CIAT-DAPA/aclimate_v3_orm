...
class ClimateHistoricalMonthly(Base):
    ...
    location = relationship("MngLocation", back_populates="climate_historical_monthly")
    measure = relationship("MngClimateMeasure", back_populates="climate_historical_monthly")

...
def upgrade() -> None:
    ...
    op.create_table('mng_country_climate_measure',
        ...
        sa.Column('spatial_forecast', sa.Boolean(), nullable=True, server_default='0'),
        sa.Column('spatial_climate', sa.Boolean(), nullable=True, server_default='0'),
        sa.Column('location_forecast', sa.Boolean(), nullable=True, server_default='0'),
        sa.Column('location_climate', sa.Boolean(), nullable=True, server_default='0'),
        sa.Column('description', sa.Text(), nullable=True),
        sa.Column('store', sa.String(length=255), nullable=True),
        sa.Column('workspace', sa.String(length=255), nullable=True),
